...
<style>
    body {
        background-image: url("{{ asset('/global_assets/images/background_haikyu.jpeg') }}");
                        ...
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <a class="d-inline-block">
                                    <img src="{{asset('global_assets/images/planet_namek.png') }}" alt="" style="height:90px;">
                                </a>
                                {{-- <i
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block" style="background-color: black">Sign in <i
